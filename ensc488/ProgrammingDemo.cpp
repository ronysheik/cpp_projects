...
void TracGeneration()
{
	...
	outfile1  << config_via_1[0] << "    " << config_via_2[0] << "    " << config_via_3[0] << "    " << config_via_g[0] << "\n";
	outfile1  << config_via_1[1] << "    " << config_via_2[1] << "    " << config_via_3[1] << "    " << config_via_g[1] << "\n";
	outfile1  << config_via_1[2] << "    " << config_via_2[2] << "    " << config_via_3[2] << "    " << config_via_g[2] << "\n";
	outfile1  << config_via_1[3] << "    " << config_via_2[3] << "    " << config_via_3[3] << "    " << config_via_g[3] << "\n";
