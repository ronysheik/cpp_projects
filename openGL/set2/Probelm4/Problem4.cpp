...
int main (int argc, char **argv) {
	...
	GLFWwindow* window = glfwCreateWindow(win_WIDTH, win_HEIGHT, "Problem 4 - Burnaby Campus Map", NULL, NULL);
	...
	unsigned char *buffer = stbi_load("SFU_MAP.jpg", &width, &height, &Channels, 0);
